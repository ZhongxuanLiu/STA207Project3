...
p3 <- plot_ly(data = covid_us, x = ~ Date_reported, y = ~ New_cases, type = "bar", name = "new cases")
p3
...
p4 <- plot_ly(data = covid_uk, x = ~ Date_reported, y = ~ New_cases, type = "bar", name = "new cases")
p4
...
p5 <- plot_ly(data = covid_cn, x = ~ Date_reported, y = ~ New_cases, type = "bar", name = "new cases")
p5
```