...
p3 <- plot_ly(data = covid_us, x = ~ Date_reported, y = ~ New_cases, type = "bar", name = "new cases") %>% layout(title = "US")
p3
...
p4 <- plot_ly(data = covid_uk, x = ~ Date_reported, y = ~ New_cases, type = "bar", name = "new cases") %>% layout(title = "UK")
p4
...
p5 <- plot_ly(data = covid_cn, x = ~ Date_reported, y = ~ New_cases, type = "bar", name = "new cases") %>% layout(title = "China")
p5
...
p6 <- plot_ly(data = covid_br, x = ~ Date_reported, y = ~ New_cases, type = "bar", name = "new cases") %>% layout(title = "Brazil")
p6
...
p7 <- plot_ly(data = covid_br, x = ~ Date_reported, y = ~ New_cases, type = "bar", name = "new cases") %>% layout(title = "South Africa")
p7
```