...
Since we are concentrating on the growth rate in the USA, we also draw an interactive plot of new cases by day. The plot of new cases by day in the USA and the analogous plot of the whole world show the similar trend on new cases. We also take a look at the trend of new cases in China and the UK. The UK has a similar trend as well. However, in China, the number of new cases is high at the beginning, much less new cases were reported after May 2020. The growth rate is extremely high in Feb 2020 and May 2020.
